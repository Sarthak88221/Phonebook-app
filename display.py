...
class Display(Toplevel):
    def __init__(self,person_id):
        ...
        self.heading = Label(self.top, text="Display", font="Times 32 bold", bg="white", fg="#426ff5")
        self.heading.place(x=240, y=40)

        self.heading = Label(self.top, text="Details", font="Times 32 bold", bg="white", fg="#111")
